...
SOURCES = ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c ft_memchr.c \
	ft_memcmp.c ft_strlen.c ft_strdup.c ft_strcpy.c ft_strcat.c \
	...
	ft_memccpy.c ft_strsplit.c ft_itoa.c ft_strnstr.c ft_strncpy.c \
	ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c \
	ft_lstmap.c ft_isspace.c ft_isupper.c ft_is_sort.c \
	ft_str_is_lowercase.c ft_swap.c \

OO = ft_memset.o ft_bzero.o ft_memcpy.o ft_memmove.o ft_memchr.o \
	...
	ft_memccpy.o ft_strsplit.o ft_itoa.o ft_strnstr.o ft_strncpy.o \
	ft_lstnew.o ft_lstdelone.o ft_lstdel.o ft_lstadd.o ft_lstiter.o \
	ft_lstmap.o ft_isspace.o ft_isupper.o ft_is_sort.o \
	ft_str_is_lowercase.o ft_swap.o \

$(NAME):
	gcc $(CFLAGS) -c $(SOURCES) -I libft.h
	ar rc $(NAME) $(OO)
